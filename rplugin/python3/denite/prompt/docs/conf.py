...
# -- Copy modules to make a correct module structure -----------------------
MODULE_DIR = os.path.join(BASE_DIR, 'module', 'prompt')
if os.path.exists(MODULE_DIR):
    shutil.rmtree(MODULE_DIR, ignore_errors=True)
os.makedirs(MODULE_DIR)
for filename in glob.glob(os.path.join(BASE_DIR, '*.py')):
    shutil.copyfile(
        filename,
        os.path.join(MODULE_DIR, os.path.basename(filename))
    )
for filename in glob.glob(os.path.join(BASE_DIR, '*.pyi')):
    shutil.copyfile(
        filename,
        os.path.join(MODULE_DIR, os.path.basename(filename))
    )
